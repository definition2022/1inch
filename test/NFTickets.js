...
describe('NFTickets', async function () {
    ...
    xit('NFT sell', async function () {
        ...
        console.log('Balances: %s %s %s %s', makerNFTicket, takerNFTicket, makerWeth, takerWeth);
        ...
        const makerNFTicket1 = await this.NFTicket.balanceOf(wallet);
        const takerNFTicket1 = await this.NFTicket.balanceOf(_);
        const makerWeth1 = await this.weth.balanceOf(wallet);
        const takerWeth1 = await this.weth.balanceOf(_);
        console.log('Balances: %d %d %d %d', makerNFTicket1, takerNFTicket1, makerWeth1 / 10 ** 18, takerWeth1 / 10 ** 18);
    ...
    xit('Ticket price protection', async function () {
        ...
        const makerWeth1 = await this.weth.balanceOf(wallet);
        const takerWeth1 = await this.weth.balanceOf(_);
        console.log('Balances: %d %d %d %d', makerNFTicket1, takerNFTicket1, makerWeth1, takerWeth1);
